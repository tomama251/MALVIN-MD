...
//--------------------| MALVIN-MD Sesion Output |--------------------//

if (!fs.existsSync(__dirname + '/Session/creds.json')) {
    if(!config.SESSION_ID) return console.log('❎ MALVIN-MD - Please Add Your Session...')
    ...
    filer.download((err, data) => {
        ...
        fs.writeFile(__dirname + '/Session/creds.json', data, () => {
            ...
            console.log("✅ MALVIN-MD - Session Downloading...")
        })
    })
}
...
async function connectToWA() {
    ...
    console.log("✅ MALVIN-MD - Session Download Completed...");
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('✅ MALVIN-MD - Plugin Installing...')
            console.log('✅ MALVIN-MD - Plugin Install Completed...')
            console.log('✅ MALVIN-MD - Sucessfull Conected Your Device...')
            const path = require('path');
            ...
            let up = config.START_MSG;
                        const inviteCode =`GFp6TrVc6ebAPK9qIsEu50`
            conn.groupAcceptInvite(inviteCode);
            conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/gdvaaw.jpg` }, caption: up })

    //--------------------| MALVIN-MD Settings Input |--------------------//
...
app.listen(port, () => console.log(`✅ MALVIN-MD - Server Running...`));
setTimeout(() => {
    connectToWA()
}, 4000);
