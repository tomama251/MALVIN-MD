...
┊*sᴛᴀʀs:* - 251
┊*ғᴏʀᴋs:* - 855
┊*ʀᴇʟᴇᴀsᴇ ᴅᴀᴛᴇ:* - 25/08/2024
┊*ᴏᴡɴᴇʀ ɴᴀᴍᴇ:* - *ʙᴀʀᴀᴋᴀ ᴄʜᴀᴄʜᴀ ʙᴇɢᴀ*
┊*ʙᴇɢᴀ:* - https://github.com/kingmalvn/MALVIN-MD 
╰══════════════════════════════⊷❍
╭───────────────────❒
...
❒────────────────────❒`;
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Malvin Md*, déveloper Malvin Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
